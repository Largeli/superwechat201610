...
import static cn.ucai.superwechat.I.MSG_GROUP_CREATE_FAIL;
import static cn.ucai.superwechat.I.MSG_GROUP_HXID_EXISTS;
                    ...
                    if (result != null) {
                        if (result.isRetMsg()) {
                            ...
                            if (result.getRetCode() == MSG_GROUP_HXID_EXISTS) {
                                CommonUtils.showLongToast("群组环信ID已经存在");
                            }
                            if (result.getRetCode() == MSG_GROUP_CREATE_FAIL) {
                                CommonUtils.showLongToast("创建群组失败");
                            }
                        }
                    }
                }
